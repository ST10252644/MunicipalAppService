namespace MunicipalServicesApp
{
    partial class ReportIssuesForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            // Base Y position and spacing
            int y = 20;
            int spacing = 90; // slightly larger spacing
            ...
            rtbDescription.Size = new Size(480, 150); // more vertical space
            rtbDescription.Location = new Point(20, y + 35);
            cardPanel.Controls.Add(rtbDescription);

            // -------- Attachment --------
            y += 180; // more space after description
            ...
            btnAttach.Size = new Size(200, 50); // bigger button
